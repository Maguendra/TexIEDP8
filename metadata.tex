\title{Architecture des Machines et des Ordinateurs} % Matière

\newcommand{\name}{Maguendra Codandamourty} % Prénom Nom
\newcommand{\studentid}{825041861} % n° étudianT
\newcommand{\subtitle}{Chapitre 1 --- Généralités sur les ordinateurs} % Titre du devoir
\newcommand{\teacher}{Philippe Kislin-Duval}
